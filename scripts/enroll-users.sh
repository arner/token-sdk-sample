...
do
  fabric-ca-client register --id.name fsc${node} --id.secret password --id.type client
...
fabric-ca-client register --id.name auditor --id.secret password --id.type client
fabric-ca-client enroll -u http://auditor:password@localhost:27054 -M "$(pwd)/keys/auditor/aud/msp"

fabric-ca-client register --id.name issuer --id.secret password --id.type client
...
fabric-ca-client register --id.name alice --id.secret password --id.type client --enrollment.type idemix --idemix.curve gurvy.Bn254
...
fabric-ca-client register --id.name bob --id.secret password --id.type client --enrollment.type idemix --idemix.curve gurvy.Bn254
...
fabric-ca-client register --id.name carlos --id.secret password --id.type client --enrollment.type idemix --idemix.curve gurvy.Bn254
fabric-ca-client enroll -u http://alice:password@localhost:27054  -M "$(pwd)/keys/owner2/wallet/carlos/msp" --enrollment.type idemix --idemix.curve gurvy.Bn254

fabric-ca-client register --id.name dan --id.secret password --id.type client --enrollment.type idemix --idemix.curve gurvy.Bn254
fabric-ca-client enroll -u http://bob:password@localhost:27054 -M "$(pwd)/keys/owner2/wallet/dan/msp" --enrollment.type idemix --idemix.curve gurvy.Bn254
