...
func (s OwnerService) TransferTokens(tokenType string, quantity uint64, sender string, recipient string, recipientNode string, message string) (txID string, err error) {
...
func (v *TransferView) Call(context view.Context) (interface{}, error) {
	...
	if w != nil {
		...
		fmt.Printf("getting local identity for %s", v.Recipient)
