...
func (s OwnerService) GetAllBalances() (walletBalance BalanceByWallet, err error) {
...
func (s OwnerService) GetBalance(wallet string, tokenType string) (typeVal ValueByTokenType, err error) {
